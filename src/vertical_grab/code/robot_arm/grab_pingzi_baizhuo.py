...
_base_robot_arm_path = os.path.dirname(os.path.abspath(__file__))
_base_code_path = os.path.dirname(_base_robot_arm_path)
if _base_robot_arm_path not in sys.path:
    sys.path.insert(0, _base_robot_arm_path)
if _base_code_path not in sys.path:
    sys.path.insert(0, _base_code_path)

from vertical_grab.interface import vertical_catch
from Robot import RobotController
from config import *

PICTURE_DIR = os.path.normpath(os.path.join(os.path.dirname(__file__), "..", "pictures"))
