...
dst_path = r"/home/maic/09-robotgui/src/vertical_grab/code/robot_arm"
sys.path.insert(0, dst_path)

from Robotic_Arm.rm_robot_interface import *
from config import ROBOT2_CONFIG, GUN1_POSITIONS, GUN2_POSITIONS, MOVE_CONFIG
import YIYEQIANG_OUT
