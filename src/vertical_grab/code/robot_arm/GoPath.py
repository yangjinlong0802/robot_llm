...
import os
import time
dst_path = "/home/maic/10-robotgui/src/vertical_grab/code/robot_arm"
os.chdir(dst_path)

# 设置轨迹文件路径
file_path = "/home/maic/10-robotgui/src/vertical_grab/code/robot_arm/Path/trajectory_005.txt"
