...
class UdpConfig:
    ...
    def rm_realtime_arm_state_call_back(self, arm_state_callback:rm_realtime_arm_state_callback_ptr): # type: ignore
        """
...
class RoboticArm(ArmState, MovePlan, JointConfigSettings, JointConfigReader, ArmTipVelocityParameters,
    ...
    def rm_get_arm_event_call_back(self, event_callback: rm_event_callback_ptr): # type: ignore
        """注册机械臂事件回调函数
